...
CREATE TABLE TB_DEPT (
    DEPT_CD NUMBER CONSTRAINT PK_TD_DCD PRIMARY KEY,
    DEPT_NAME VARCHAR2(30) CONSTRAINT NN_TD_DNAME NOT NULL
);
...
CREATE TABLE TB_EMP (
    EMP_NO NUMBER CONSTRAINT PK_TE_ENO PRIMARY KEY,
    EMP_NAME VARCHAR2(20) CONSTRAINT NN_TE_ENAME NOT NULL,
    GENDER CHAR(1) CONSTRAINT CH_TE_GENDER CHECK(GENDER IN ('M', 'F')),
    DEPT_CD NUMBER CONSTRAINT FK_TE_DCD REFERENCES TB_DEPT(DEPT_CD)
);
...
ALTER TABLE TB_EMP ADD CONSTRAINT UQ_TE_CONTACT UNIQUE(CONTACT);
